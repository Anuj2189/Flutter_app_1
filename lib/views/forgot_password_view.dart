...
import 'package:flutter_application_1/dialog/password_reset_email_dialog.dart';
    ...
    return BlocListener<AuthBloc,AuthState>(listener:(context, state) async {
     if(state is AuthStateForgotPassword){
      ...
      if(state.exception != null){
        await showErrorDialog(context, 'We could not process your request.Please make sure you have registered with the email provided');
      }
     } 
    }, child:  Scaffold(
      appBar: AppBar(
      ...
      body: Padding(
        ...
        child: Column(
        children: [
          const Text('Please enter your email to send you password reset link'),
          TextField(
