...
if(db==null){
  ...
  Future<void> open() async{
   ...
   try{
    final reqpath = await getApplicationDocumentsDirectory();
    final dbPath = join(reqpath.path,dbName);
...
class DatabaseNote{
  ...
  userId = map[userIdColumn] as int, text = map[textColumn] as String, isSyncedWithCloud = (map[isSyncedWithCloudColumn] as int) == 1? true:false;
  @override
